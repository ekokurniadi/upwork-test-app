...
export default function SearchBox() {
  return (
    <Flex alignItems="center" justify="space-between" height="9" w="80%" borderRadius={4} bg="#f0f0f0">
      <Flex justifyContent="center" alignItems="center" direction="row">
          <Flex alignItems="center" ml={1} justifyContent="center" width={20} bg="white" borderRadius={4}>
